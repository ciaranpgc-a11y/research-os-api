...
const sizeSpacing: Record<NonNullable<LegacyButtonPrimitiveProps['size']>, React.CSSProperties> = {
  sm: {
...
export interface LegacyButtonPrimitiveProps
  extends React.ButtonHTMLAttributes<HTMLButtonElement>,
    VariantProps<typeof legacyButtonPrimitiveVariants> {
  asChild?: boolean
}

const LegacyButtonPrimitive = React.forwardRef<HTMLButtonElement, LegacyButtonPrimitiveProps>(
  ({ className, variant, size, asChild = false, style, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        className={cn(legacyButtonPrimitiveVariants({ variant: resolvedVariant, size: resolvedSize }), className)}
        style={{
...
LegacyButtonPrimitive.displayName = 'LegacyButtonPrimitive'

export { LegacyButtonPrimitive }
