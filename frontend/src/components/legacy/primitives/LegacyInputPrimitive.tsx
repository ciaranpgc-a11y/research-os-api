...
const legacyInputPrimitiveVariants = cva(
  [
...
export interface LegacyInputPrimitiveProps
  extends Omit<React.InputHTMLAttributes<HTMLInputElement>, 'size'>,
    VariantProps<typeof legacyInputPrimitiveVariants> {}

const LegacyInputPrimitive = React.forwardRef<HTMLInputElement, LegacyInputPrimitiveProps>(
  ({ className, size, style, ...props }, ref) => {
    ...
    return (
      <input
        ...
        className={cn(legacyInputPrimitiveVariants({ size: resolvedSize }), className)}
        style={{
...
LegacyInputPrimitive.displayName = 'LegacyInputPrimitive'

export { LegacyInputPrimitive }
