 ...
 * - Motion: --motion-duration-ui with --motion-ease-default
...
const legacyTablePrimitiveVariants = cva(
  [
...
interface LegacyTablePrimitiveProps
  extends React.TableHTMLAttributes<HTMLTableElement>,
    VariantProps<typeof legacyTablePrimitiveVariants> {
  layoutTable?: boolean
}

const LegacyTablePrimitive = React.forwardRef<HTMLTableElement, LegacyTablePrimitiveProps>(
  ({ className, striped = true, hoverable = true, compact = false, layoutTable = false, role, ...props }, ref) => {
    ...
    return (
      ...
      <table
        ...
        className={cn(legacyTablePrimitiveVariants({ striped: resolvedStriped, hoverable: resolvedHoverable, compact: resolvedCompact }), className)}
        {...props}
      />
...
LegacyTablePrimitive.displayName = 'LegacyTablePrimitive'

const LegacyTableHead = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => (
    <thead
      ref={ref}
...
LegacyTableHead.displayName = 'LegacyTableHead'

interface LegacyTableHeaderCellProps extends React.ThHTMLAttributes<HTMLTableCellElement> {
  sortable?: boolean
  sortDirection?: SortDirection
  selection?: boolean
}

const LegacyTableHeaderCell = React.forwardRef<HTMLTableCellElement, LegacyTableHeaderCellProps>(
...
LegacyTableHeaderCell.displayName = 'LegacyTableHeaderCell'

interface LegacyTableBodyProps extends React.HTMLAttributes<HTMLTableSectionElement> {
  isLoading?: boolean
  isEmpty?: boolean
  emptyMessage?: string
  columnCount?: number
...
const LegacyTableBody = React.forwardRef<HTMLTableSectionElement, LegacyTableBodyProps>(
  (
    {
      className,
      children,
...
LegacyTableBody.displayName = 'LegacyTableBody'

const LegacyTableRow = React.forwardRef<HTMLTableRowElement, React.HTMLAttributes<HTMLTableRowElement>>(
...
LegacyTableRow.displayName = 'LegacyTableRow'

interface LegacyTableCellProps extends React.TdHTMLAttributes<HTMLTableCellElement> {
  secondary?: boolean
  selection?: boolean
  checked?: boolean
}

const LegacyTableCell = React.forwardRef<HTMLTableCellElement, LegacyTableCellProps>(
...
LegacyTableCell.displayName = 'LegacyTableCell'
