...
const badgePrimitiveVariants = cva(
  [
...
export interface BadgePrimitiveProps
  extends React.HTMLAttributes<HTMLSpanElement>,
    VariantProps<typeof badgePrimitiveVariants> {}

const BadgePrimitive = React.forwardRef<HTMLSpanElement, BadgePrimitiveProps>(
  ({ className, variant, size, style, ...props }, ref) => {
    ...
    return (
      <span
        ...
        className={cn(badgePrimitiveVariants({ variant: resolvedVariant, size: resolvedSize }), className)}
        style={{
...
export { BadgePrimitive, badgePrimitiveVariants }
