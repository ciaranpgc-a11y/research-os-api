...
const textareaPrimitiveVariants = cva(
  [
...
export interface TextareaPrimitiveProps
  extends Omit<React.TextareaHTMLAttributes<HTMLTextAreaElement>, 'size'>,
    VariantProps<typeof textareaPrimitiveVariants> {}

const TextareaPrimitive = React.forwardRef<HTMLTextAreaElement, TextareaPrimitiveProps>(
  ({ className, size, resize, style, ...props }, ref) => {
    ...
    return (
      <Textarea
        ...
        className={cn(textareaPrimitiveVariants({ size: resolvedSize, resize: resolvedResize }), className)}
        style={{
...
export { TextareaPrimitive, textareaPrimitiveVariants }
