 ...
 * - Motion: --motion-ui (fallback --motion-duration-ui)
...
const SelectPrimitive = RadixSelect.Root
  ...
  <RadixSelect.Portal>
    <RadixSelect.Content
      ...
      className={cn(
        ...
        'animate-[select-slide-down_var(--motion-ui,var(--motion-duration-ui))_var(--motion-ease-default)]',
        className,
      )}
      {...props}
    >
