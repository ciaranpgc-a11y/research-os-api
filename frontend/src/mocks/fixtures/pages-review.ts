...
export const pagesReviewLibraryAssets: LibraryAssetRecord[] = [
  ...
  },
  {
    ...
    shared_with: [],
    pending_with: [
      { user_id: 'storybook-owner-user', name: 'Morgan Hale', role: 'viewer' },
      { user_id: 'storybook-editor-user', name: 'Avery Cole', role: 'viewer' },
      { user_id: 'storybook-reviewer-user', name: 'Jordan Pike', role: 'viewer' },
      { user_id: 'storybook-viewer-user', name: 'Riley Hart', role: 'viewer' },
      { user_id: 'storybook-removed-user', name: 'Casey Moore', role: 'viewer' },
    ],
    is_available: true,
  },
  {
