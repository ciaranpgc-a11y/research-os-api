...
export const houseSurfaces = {
  ...
  leftBorderAdmin: 'house-left-border-admin',
  leftBorderOpportunities: 'house-left-border-opportunities',
  leftBorderReport: 'house-left-border-report',
...
export const houseNavigation = {
  ...
  itemAdmin: 'house-nav-item-admin',
  itemOpportunities: 'house-nav-item-opportunities',
  itemReport: 'house-nav-item-report',
...
export const houseForms = {
  ...
  expanderShell: 'house-form-expander-shell',
  expanderTrigger: 'house-form-expander-trigger',
  expanderPanel: 'house-form-expander-panel',
...
export const houseCollaborators = {
  ...
  actionIconConfirm: 'house-collaborator-action-icon-save',
  actionIconSave: 'house-collaborator-action-icon-save',
  actionIconDiscard: 'house-collaborator-action-icon-discard',
...
export const houseElements = {
  ...
  formExpanderShell: houseForms.expanderShell,
  formExpanderTrigger: houseForms.expanderTrigger,
  formExpanderPanel: houseForms.expanderPanel,
  ...
  collaboratorActionIconSave: houseCollaborators.actionIconSave,
  collaboratorActionIconDiscard: houseCollaborators.actionIconDiscard,
  ...
  leftBorderAdmin: houseSurfaces.leftBorderAdmin,
  leftBorderOpportunities: houseSurfaces.leftBorderOpportunities,
  leftBorderReport: houseSurfaces.leftBorderReport,
