...
export const houseCollaborators = {
  ...
  chipViewOnly: 'house-collaborator-chip-view-only',
...
export const houseDrilldown = {
  ...
  navTabTrigger: 'house-drilldown-nav-tab-trigger',
  navTabList: 'house-drilldown-nav-tab-list',
...
export const houseElements = {
  ...
  collaboratorChipViewOnly: houseCollaborators.chipViewOnly,
