...
const PUBLICATION_STRUCTURED_TABLE_CLASS_NAME = [
  ...
  '[&_thead]:border-b-2 [&_thead]:border-[hsl(var(--tone-neutral-250))] [&_th]:border-b [&_th]:border-[hsl(var(--tone-neutral-200))] [&_th]:px-3.5 [&_th]:py-2.5 [&_th]:text-left [&_th]:align-top [&_th]:whitespace-normal [&_th]:break-words [&_th]:text-[0.68rem] [&_th]:font-semibold [&_th]:uppercase [&_th]:tracking-[0.08em] [&_th]:text-[hsl(var(--tone-neutral-500))]',
...
const PUBLICATION_STRUCTURED_TABLE_LIGHTBOX_CLASS_NAME = [
  ...
  '[&_thead]:border-b-2 [&_thead]:border-[hsl(var(--tone-neutral-250))] [&_th]:border-b [&_th]:border-[hsl(var(--tone-neutral-200))] [&_th]:bg-[hsl(var(--tone-neutral-50))] [&_th]:px-4 [&_th]:py-3 [&_th]:text-left [&_th]:align-top [&_th]:whitespace-normal [&_th]:break-words [&_th]:text-[0.72rem] [&_th]:font-semibold [&_th]:uppercase [&_th]:tracking-[0.08em] [&_th]:text-[hsl(var(--tone-neutral-500))]',
