...
import {
  ...
  ModalFooter,
  ModalClose,
} from '@/components/primitives/ModalPrimitive'
  ...
  return (
    <ModalPrimitive>
      <ModalTrigger asChild>
        <ButtonPrimitive size="sm">Open {size.toUpperCase()} modal</ButtonPrimitive>
      </ModalTrigger>
      <ModalContent size={size} scrollable={scrollable}>
        ...
        {withFooter ? (
          <ModalFooter>
            <ButtonPrimitive variant="ghost" size="sm">Cancel</ButtonPrimitive>
            <ButtonPrimitive size="sm">Confirm</ButtonPrimitive>
          </ModalFooter>
        ) : null}
      </ModalContent>
    </ModalPrimitive>
