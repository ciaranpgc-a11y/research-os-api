...
import { TextareaPrimitive } from '@/components/primitives/TextareaPrimitive'
      ...
      <div data-ui="textarea-primitive-story" className="max-w-2xl space-y-5">
        <section data-ui="textarea-primitive-sizes" className="space-y-2">
          ...
          <div data-ui="textarea-primitive-sizes-grid" className="grid gap-2">
            <TextareaPrimitive data-ui="textarea-primitive-size-sm" size="sm" defaultValue="Small textarea" readOnly />
            <TextareaPrimitive data-ui="textarea-primitive-size-md" size="md" defaultValue="Medium textarea" readOnly />
            <TextareaPrimitive data-ui="textarea-primitive-size-lg" size="lg" defaultValue="Large textarea" readOnly />
          </div>
        </section>
        ...
        <section data-ui="textarea-primitive-states" className="space-y-2">
          ...
          <div data-ui="textarea-primitive-states-grid" className="grid gap-2">
            <TextareaPrimitive data-ui="textarea-primitive-default" placeholder="Default state with placeholder" />
            <TextareaPrimitive data-ui="textarea-primitive-focus" autoFocus defaultValue="Focus state preview" />
            <TextareaPrimitive data-ui="textarea-primitive-error" aria-invalid="true" defaultValue="Error via aria-invalid=true" readOnly />
            <TextareaPrimitive data-ui="textarea-primitive-disabled" disabled defaultValue="Disabled state" readOnly />
          </div>
        </section>
        ...
        <section data-ui="textarea-primitive-placeholder" className="space-y-2">
          ...
          <div data-ui="textarea-primitive-placeholder-grid" className="grid gap-2">
            <TextareaPrimitive data-ui="textarea-primitive-placeholder-only" placeholder="Placeholder only" />
            <TextareaPrimitive data-ui="textarea-primitive-value-only" defaultValue="Value only content" readOnly />
            <TextareaPrimitive data-ui="textarea-primitive-empty-no-placeholder" />
          </div>
        </section>
        ...
        <section data-ui="textarea-primitive-resize" className="space-y-2">
          ...
          <div data-ui="textarea-primitive-resize-grid" className="grid gap-2 md:grid-cols-2">
            <div data-ui="textarea-primitive-resize-vertical-wrap" className="rounded-md border border-border bg-card p-3">
              ...
              <TextareaPrimitive data-ui="textarea-primitive-resize-vertical" resize="vertical" placeholder="Drag bottom edge to resize" />
            </div>
            <div data-ui="textarea-primitive-resize-none-wrap" className="rounded-md border border-border bg-card p-3">
              ...
              <TextareaPrimitive data-ui="textarea-primitive-resize-none" resize="none" placeholder="Resize disabled" />
            </div>
          </div>
        </section>
