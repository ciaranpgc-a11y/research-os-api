        ...
        <div data-ui="tooltip-primitive-story" className="space-y-5">
          <section data-ui="tooltip-basic-section" className="space-y-2">
            ...
            <TooltipPrimitive>
              ...
              <TooltipContent data-ui="tooltip-basic-content">Basic helpful context</TooltipContent>
            </TooltipPrimitive>
          </section>
          ...
          <section data-ui="tooltip-arrow-section" className="space-y-2">
            ...
            <TooltipPrimitive>
              ...
              <TooltipContent data-ui="tooltip-arrow-content" withArrow>
          ...
          <section data-ui="tooltip-long-section" className="space-y-2">
            ...
            <TooltipPrimitive>
              ...
              <TooltipContent data-ui="tooltip-long-content" className="max-w-[20rem] whitespace-normal">
            ...
            <TooltipPrimitive>
              <TooltipTrigger asChild>
                <div data-ui="tooltip-button-trigger-wrap" className="inline-flex">
                  <ButtonPrimitive data-ui="tooltip-button-trigger" size="sm" variant="secondary">
                    Save Draft
                  </ButtonPrimitive>
                </div>
              </TooltipTrigger>
              <TooltipContent data-ui="tooltip-button-content">
