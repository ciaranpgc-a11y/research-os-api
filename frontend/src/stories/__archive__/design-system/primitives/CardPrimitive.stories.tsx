        ...
        <section data-ui="card-primitive-full-section" className="space-y-2">
          ...
          <CardPrimitive data-ui="card-primitive-full" className="max-w-xl">
            ...
            <CardFooter data-ui="card-primitive-full-footer">
              <LegacyButtonPrimitive data-ui="card-primitive-full-primary-action" size="sm">Open Detail</LegacyButtonPrimitive>
              <LegacyButtonPrimitive data-ui="card-primitive-full-secondary-action" size="sm" variant="ghost">Dismiss</LegacyButtonPrimitive>
            </CardFooter>
          </CardPrimitive>
        </section>
        ...
        <section data-ui="card-primitive-interactive-section" className="space-y-2">
          ...
          <CardPrimitive data-ui="card-primitive-interactive" interactive className="max-w-xl">
            ...
            <CardFooter data-ui="card-primitive-interactive-footer">
              <LegacyButtonPrimitive data-ui="card-primitive-interactive-action" size="sm">Inspect</LegacyButtonPrimitive>
            </CardFooter>
          </CardPrimitive>
        </section>
      </div>
