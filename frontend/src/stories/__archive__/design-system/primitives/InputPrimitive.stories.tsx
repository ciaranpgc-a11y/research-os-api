...
import { LegacyInputPrimitive } from '@/components/legacy/primitives/LegacyInputPrimitive'
import { StoryFrame } from '../_helpers/StoryFrame'

const meta = {
  title: 'Design System/Primitives/Input Primitive',
  component: LegacyInputPrimitive,
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: {
...
} satisfies Meta<typeof LegacyInputPrimitive>
      ...
      <div data-ui="input-primitive-story" className="max-w-xl space-y-5">
        <section data-ui="input-primitive-sizes" className="space-y-2">
          ...
          <div data-ui="input-primitive-sizes-grid" className="grid gap-2">
            <LegacyInputPrimitive data-ui="input-primitive-size-sm" size="sm" defaultValue="Small (h-10, min 44px)" readOnly />
            <LegacyInputPrimitive data-ui="input-primitive-size-md" size="md" defaultValue="Medium (h-11)" readOnly />
            <LegacyInputPrimitive data-ui="input-primitive-size-lg" size="lg" defaultValue="Large (h-14)" readOnly />
          </div>
        </section>
        ...
        <section data-ui="input-primitive-states" className="space-y-2">
          ...
          <div data-ui="input-primitive-states-grid" className="grid gap-2">
            <LegacyInputPrimitive data-ui="input-primitive-default" placeholder="Default state with placeholder" />
            <LegacyInputPrimitive data-ui="input-primitive-focus" aria-label="Input focus target" defaultValue="Focus state preview" autoFocus />
            <LegacyInputPrimitive data-ui="input-primitive-error" aria-invalid="true" defaultValue="Error state via aria-invalid=true" readOnly />
            <LegacyInputPrimitive data-ui="input-primitive-disabled" disabled defaultValue="Disabled state" readOnly />
          </div>
        </section>
        ...
        <section data-ui="input-primitive-content-cases" className="space-y-2">
          ...
          <div data-ui="input-primitive-content-cases-grid" className="grid gap-2">
            <LegacyInputPrimitive data-ui="input-primitive-placeholder-only" placeholder="Placeholder only" />
            <LegacyInputPrimitive data-ui="input-primitive-value-only" defaultValue="Value only" readOnly />
            <LegacyInputPrimitive data-ui="input-primitive-empty-no-placeholder" />
          </div>
        </section>
